...
namespace True.TECH.Migrations
{
    /// <inheritdoc />
    public partial class InitialEntitiesMig : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_TRUEPriceTypes.TECH", x => x.Id);
                });

            migrationBuilder.CreateTable(
                name: "TRUEProducts.TECH",
                columns: table => new
                {
                    Id = table.Column<Guid>(type: "uuid", nullable: false),
                    Name = table.Column<string>(type: "character varying(256)", maxLength: 256, nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_TRUEProducts.TECH", x => x.Id);
                });

            migrationBuilder.CreateTable(
                name: "TRUEStores.TECH",
                columns: table => new
                {
                    Id = table.Column<Guid>(type: "uuid", nullable: false),
                    Name = table.Column<string>(type: "character varying(128)", maxLength: 128, nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_TRUEStores.TECH", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_TRUEProductImages.TECH", x => x.Id);
                    table.ForeignKey(
                        name: "FK_TRUEProductImages.TECH_TRUEProducts.TECH_ProductId",
                        column: x => x.ProductId,
                        principalTable: "TRUEProducts.TECH",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                });

            migrationBuilder.CreateTable(
                name: "TRUEProductPrices.TECH",
                columns: table => new
                {
                    Id = table.Column<Guid>(type: "uuid", nullable: false),
                    ProductId = table.Column<Guid>(type: "uuid", nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_TRUEProductPrices.TECH", x => x.Id);
                    table.ForeignKey(
                        name: "FK_TRUEProductPrices.TECH_TRUEPriceTypes.TECH_PriceTypeId",
                        column: x => x.PriceTypeId,
                        principalTable: "TRUEPriceTypes.TECH",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_TRUEProductPrices.TECH_TRUEProducts.TECH_ProductId",
                        column: x => x.ProductId,
                        principalTable: "TRUEProducts.TECH",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_TRUEProductStocks.TECH", x => x.Id);
                    table.ForeignKey(
                        name: "FK_TRUEProductStocks.TECH_TRUEProducts.TECH_ProductId",
                        column: x => x.ProductId,
                        principalTable: "TRUEProducts.TECH",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_TRUEProductStocks.TECH_TRUEStores.TECH_StoreId",
                        column: x => x.StoreId,
                        principalTable: "TRUEStores.TECH",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_TRUEPriceTypes.TECH_Name",
                table: "TRUEPriceTypes.TECH",
                column: "Name",
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_TRUEProductImages.TECH_ProductId",
                table: "TRUEProductImages.TECH",
                column: "ProductId");

            migrationBuilder.CreateIndex(
                name: "IX_TRUEProductPrices.TECH_PriceTypeId",
                table: "TRUEProductPrices.TECH",
                column: "PriceTypeId");

            migrationBuilder.CreateIndex(
                name: "IX_TRUEProductPrices.TECH_ProductId_PriceTypeId",
                table: "TRUEProductPrices.TECH",
                columns: new[] { "ProductId", "PriceTypeId" },
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_TRUEProducts.TECH_Name",
                table: "TRUEProducts.TECH",
                column: "Name");

            migrationBuilder.CreateIndex(
                name: "IX_TRUEProductStocks.TECH_ProductId_StoreId",
                table: "TRUEProductStocks.TECH",
                columns: new[] { "ProductId", "StoreId" },
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_TRUEProductStocks.TECH_StoreId",
                table: "TRUEProductStocks.TECH",
                column: "StoreId");

            migrationBuilder.CreateIndex(
                name: "IX_TRUEStores.TECH_Name",
                table: "TRUEStores.TECH",
                column: "Name");
        }
