...
namespace True.TECH.Migrations
{
    ...
    [Migration("20260426211713_InitialEntitiesMig")]
    partial class InitialEntitiesMig
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("True.TECH.Entities.PriceTypes.Entites.PriceType", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid");
                    ...
                    b.ToTable("TRUEPriceTypes.TECH", (string)null);
                });

            modelBuilder.Entity("True.TECH.Entities.Products.Entites.Product", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid");
                    ...
                    b.ToTable("TRUEProducts.TECH", (string)null);
                });

            modelBuilder.Entity("True.TECH.Entities.Products.Entites.ProductImage", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid");
                    ...
                    b.ToTable("TRUEProductImages.TECH", (string)null);
                });

            modelBuilder.Entity("True.TECH.Entities.Products.Entites.ProductPrice", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid");
                    ...
                    b.ToTable("TRUEProductPrices.TECH", (string)null);
                });

            modelBuilder.Entity("True.TECH.Entities.Products.Entites.ProductStock", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid");
                    ...
                    b.ToTable("TRUEProductStocks.TECH", (string)null);
                });

            modelBuilder.Entity("True.TECH.Entities.Stores.Entites.Store", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid");
                    ...
                    b.ToTable("TRUEStores.TECH", (string)null);
                });
            ...
            modelBuilder.Entity("True.TECH.Entities.Products.Entites.ProductImage", b =>
                {
                    b.HasOne("True.TECH.Entities.Products.Entites.Product", "Product")
                        .WithMany("Images")
            ...
            modelBuilder.Entity("True.TECH.Entities.Products.Entites.ProductPrice", b =>
                {
                    b.HasOne("True.TECH.Entities.PriceTypes.Entites.PriceType", "PriceType")
                        .WithMany()
            ...
            modelBuilder.Entity("True.TECH.Entities.Products.Entites.ProductStock", b =>
                {
                    ...
                    b.HasOne("True.TECH.Entities.Stores.Entites.Store", "Store")
                        .WithMany("Products")
